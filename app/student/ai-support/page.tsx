...
export default function AISupportPage() {
  ...
  return (
    <div className="animate-fadeIn" style={{ height: 'calc(100vh - 140px)', display: 'flex', flexDirection: 'column' }}>
      {/* Disclaimer */}
      <div style={{ padding: '10px 16px', background: '#fef3c7', borderRadius: '0', marginBottom: 16, fontSize: '0.8rem', color: '#92400e', fontWeight: 500, display: 'flex', alignItems: 'center', gap: 8 }}>
