...
export default function StudentDashboard() {
  ...
  return (
    <div className="animate-fadeIn" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      {/* AI Greeting Card */}
      <div style={{ background: 'var(--bg-accent)', borderRadius: 'var(--radius-lg)', padding: 24, display: 'flex', gap: 16, alignItems: 'flex-start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        <Link href="/student/ai-support" style={{ textDecoration: 'none' }}>
        ...
        <Link href="/student/counsellors" style={{ textDecoration: 'none' }}>
          <div className="glass-card" style={{ padding: '18px 24px', display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{ width: 44, height: 44, borderRadius: 'var(--radius-lg)', background: 'var(--bg-accent)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {/* Daily Quote */}
      <div style={{ background: 'var(--bg-accent)', borderRadius: 'var(--radius-lg)', padding: 24 }}>
